...
\begin{figure}[H]
    \centering
\includegraphics[width=1\textwidth]{diagrams/out/software-architecture/domain-model/domain-model.pdf}
...
\begin{figure}[H]
    \centering
\includegraphics[width=1\textwidth]{diagrams/out/components/architecture-backend-components/Components.pdf}
